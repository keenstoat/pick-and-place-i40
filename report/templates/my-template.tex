...
% $-- $before-title.tex()$ % This is removed so the original title page is not created
% $-- % $title.tex()$ % This is removed so the original title page is not created

\begin{document}

% $-- $before-body.tex()$ % This is removed so the original title page is not created

$my-title.tex()$ % This is added so our custom titlepage is created
